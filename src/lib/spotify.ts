...
export const normalizePlaylist = (source: PlaylistSource, oembed?: Record<string, unknown>): Playlist => ({
  ...source,
  title: source.title,
  ...
  thumbnail_width: typeof oembed?.thumbnail_width === 'number' ? oembed.thumbnail_width : undefined,
  thumbnail_height: typeof oembed?.thumbnail_height === 'number' ? oembed.thumbnail_height : undefined,
});
